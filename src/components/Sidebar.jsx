...
export default function Sidebar({ active }) {
  ...
  const items = [
    ...
    {
      id: 'purchase', label: 'Закупка', path: '/purchase',
    ...
    {
      id: 'pharmacies', label: 'Аптеки', path: '/pharmacies',
  ...
  return (
    <aside className="sidebar">
      <nav className="sidebar-rail">
        <div className="rail-logo">MP</div>
        {items.map(item => (
          <button
            key={item.id}
          ...
          >
            <div className="rail-icon-wrap">{item.icon}</div>
